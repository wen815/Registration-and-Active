...
$MailServer = "smtp.sina.com"; //SMTP服务器
    ...
    $smtpMail = "heidere@sina.com"; //SMTP服务器的用户邮箱
    $smtpuser = "heidere@sina.com"; //SMTP服务器的用户帐号
    $smtppass = "adg19880"; //SMTP服务器的用户密码
    ...
    $emailBody = "亲爱的".$username."：<br/>感谢您在我站注册了新帐号。<br/>请点击链接激活您的帐号。<br/><a href='http://localhost/email/active.php?verify=".$token."' target='_blank'>http://localhost/email/active.php?verify=".$token."</a><br/>如果以上链接无法点击，请将它复制到你的浏览器地址栏中进入访问，该链接24小时内有效。<br/>如果此次激活请求非你本人所发，请忽略本邮件。<br/><p style='text-align:right'>-------- 百度经验 敬上</p>";
